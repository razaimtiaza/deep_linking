...
import 'package:deep_linking/path_constant.dart';
import 'package:deep_linking/route_services.dart';
  ...
  Future<void> initDynamicLinks() async {
    dynamicLinks.onLink.listen((dynamicLinkData) {
      ...
      if (queryParams.isNotEmpty) {
        // Handle if there are query parameters
        // For now, let's simply navigate to the home screen
